            ...
            <div className='container md:hidden bg-[white] pt-10 mx-auto '>
                <div className='flex flex-wrap border-2 mx-5  border-slate-300/50 custom-shadow-mobile content-center divide-x	  rounded-lg'>
                    <div className="w-3/5 dropdown flex items-center   py-2  px-4 ...">
                        <Dropdown
                            inline
                            label={isChoose ? <div className='w-full text-sm text-start'><h1 className='font-medium'>{selectedTitle}</h1><p><i className='fa  fa-map-marker text-[#6ACDE9] mr-2'></i>{selectedLoc}</p></div> : <div className='py-2  text-[16px]   w-full font-medium'><i class="fa fa-map-marker" aria-hidden="true" style={{ color: ' #6E6E6E' }}></i> Choose your stay</div>}
                        >
                    ...
                    <div className="w-2/5 dropdown pl-0  py-2 pr-3 ...">
                        <Dropdown
                            ...
                            inline
                            label={<div className='text-center items-center  w-full'><div className='text-[17px] font-medium'><i class="fa fa-users text-sm" aria-hidden="true" style={{ color: ' #6E6E6E' }}></i> Guests</div>
