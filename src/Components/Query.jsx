...
export default function Query() {
  ...
  return (
    <div className='bg-[#FEDD89] w-full md:text-center max-md:items-center py-12 mt-10'>
      <img className='z-10 max-md:hidden ml-[-2.2%] mt-[-0.9%] h-[250px]' src={leaves} style={{
      ...
      <button className='rounded-full py-2 max-md:ml-[32%] px-5 md:text-xl bg-white text-black md:mt-10 mt-5 text-center' onClick={() => { contactUs() }}>Ask us Query</button>
    </div>
  )
}
