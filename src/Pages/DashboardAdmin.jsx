...
// import { getAllAdmin } from "../../../backend/controllers/user";
import DashBoardAdminRow from "../Components/DashBoardAdminRow";
import { getAllAdmins } from "../Store/adminSlice";
            ...
            <div className="md:container mx-auto pt-5 md:px-10 px-6 mb-5">
                <div>
                    <div className="md:container mx-auto relative">
                        ...
                        <div>
                            <Link
                                className="block text-center w-full bg-[#F79489] text-white py-1 px-5 rounded-xl hover:bg-white hover:text-[#F79489] border-2 border-secondary transition duration-200 box-border text-l mb-5 font-poppins" to="/dashboard/admin/add"
                            >
                                Add Admin
                            </Link>
                ...
                {admin &&
                    admin.allAdmins?.map((admin) => <DashBoardAdminRow admin={admin} />)}
            </div>
        </>
    )
}